...
void main() {
  ...
  group('Spec 014 visual goldens (390x844)', () {
    ...
    testWidgets('G-011 Sales New light', (t) async { await pump(t, const SalesPage(), AppTheme.light, _salesOverrides()); await t.ensureVisible(find.text('Registrar venda')); await t.pumpAndSettle(); await golden(find.byType(SalesPage), 'vendas_nova_claro'); });
    testWidgets('G-012 Sales New dark', (t) async { await pump(t, const SalesPage(), AppTheme.dark, _salesOverrides()); await t.ensureVisible(find.text('Registrar venda')); await t.pumpAndSettle(); await golden(find.byType(SalesPage), 'vendas_nova_escuro'); });
