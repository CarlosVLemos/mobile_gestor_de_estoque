...
- [x] Provar por gate executado que nenhuma chamada HTTP é tentada nos fluxos normais do demo.
- [x] Provar que o runtime normal mantém os providers reais e não recebe seed/gateway demo.
- [x] Testar parser, bootstrap, auth, isolamento, seed repetido, catálogo, dashboard, venda/outbox e teardown.
- [x] Executar os gates autorizados: testes focados, suíte completa e análise estática.
- [x] Documentar o comando `flutter run --dart-define=APP_MODE=demo`, limitações e procedimento de reset controlado.
